...
def plot_cobweb(r, num_iterations, initial_value, max_mines, max_mercury, pause_time):
    ...
    ax.legend()
    plt.show()
def plot_cobweb_no_time(r, num_iterations, initial_value, max_mines, max_mercury):
    x = np.linspace(0, 1, 400)
    y = logistic_map(r, x, max_mercury)
...
if(pause_time==0): plot_cobweb_no_time(r_value, num_iterations, initial_value, max_mines, max_mercury)
else: plot_cobweb(r_value, num_iterations, initial_value, max_mines, max_mercury, pause_time)
